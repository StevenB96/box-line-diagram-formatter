...
class NumberedCanvas(tk.Canvas):
    TABLEAU_COLORS = [
        ...
        '#b07aa1', '#ff9da7', '#9c755f', '#bab0ac', '#dede00', '#d55e00',
        '#0072b2', '#cc79a7', '#56b4e9', '#0072b2', '#999999', '#000000'
    ]
    
    def __init__(self, parent, grid_spacing, entities, *args, **kwargs):
    ...
    def draw_grid(self):
        ...
        for entity in self.entities:
            # use Tableau Colors for entity lines
            color = self.TABLEAU_COLORS[i % len(self.TABLEAU_COLORS)]
            i += 1
